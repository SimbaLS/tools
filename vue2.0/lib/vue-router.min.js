...
! function(t, e) {
	...
	function f(t) {
		...
		void 0 === n && (n = {});
		var r = t.hash;
		return void 0 === r && (r = ""), (e || "/") + u(n) + r
	}

	function p(t, e) {
		return e === mt ? t === e : !!e && (t.path && e.path ? t.path.replace(gt, "") === e.path.replace(gt, "") && t.hash === e.hash && h(t.query, e.query) : !(!t.name || !e.name) && (t.name === e.name && t.hash === e.hash && h(t.query, e.query) && h(t.params, e.params)))
	}
	...
	function g(t) {
		if(!g.installed) {
			g.installed = !0, lt = t, Object.defineProperty(t.prototype, "$router", {
				get: function() {
			...
			}), t.component("router-view", dt), t.component("router-link", bt);
	...
	function O(t) {
		...
		return function(n, r) {
			for(var o = "", i = n || {}, a = r || {}, u = a.pretty ? x : encodeURIComponent, c = 0; c < t.length; c++) {
				var s = t[c];
				if("string" != typeof s) {
					var f, p = i[s.name];
					if(null == p) {
					...
					if(kt(p)) {
						...
						for(var h = 0; h < p.length; h++) {
							if(f = u(p[h]), !e[c].test(f)) throw new TypeError('Expected all "' + s.name + '" to match "' + s.pattern + '", but received `' + JSON.stringify(f) + "`");
							o += (0 === h ? s.prefix : s.delimiter) + f
						}
					} else {
						if(f = s.asterisk ? k(p) : u(p), !e[c].test(f)) throw new TypeError('Expected "' + s.name + '" to match "' + s.pattern + '", but received "' + f + '"');
						o += s.prefix + f
					}
				} else o += s
			}
	...
	function T(t, e, n) {
		...
		return r || (i = (p ? i.slice(0, -f.length) : i) + "(?:" + f + "(?=$))?"), i += o ? "$" : r && p ? "" : "(?=" + f + "|$)", R(new RegExp("^" + i, A(n)), e)
	}

	function q(t, e, n) {
		return kt(e) || (n = e || n, e = []), n = n || {}, t instanceof RegExp ? $(t, e) : kt(t) ? _(t, e, n) : S(t, e, n)
	}
	...
	function P(t, e, n, i, a) {
		var u = n.path,
			c = n.name;
		r(null != u, '"path" is required in a route configuration.');
		var s = {
			path: U(u, i),
		...
		n.children && n.children.forEach(function(n) {
			...
			path: n.alias
		}, i, s.path)), t[s.path] = s, c && (e[c] ? o(!1, 'Duplicate named routes definition: { name: "' + c + '", path: "' + s.path + '" }') : e[c] = s)
	}
	...
	function L(t) {
		function e(t, e, n) {
			...
			if(o) {
				...
				if("object" != typeof r.params && (r.params = {}), e && "object" == typeof e.params)
					for(var c in e.params) !(c in r.params) && u.indexOf(c) > -1 && (r.params[c] = e.params[c]);
				if(i) return r.path = B(i.path, r.params, 'named route "' + o + '"'), a(i, r, n)
			} else if(r.path) {
				r.params = {};
				for(var p in s)
					if(M(p, r.params, r.path)) return a(s[p], r, n)
			}
			return a(null, r)
		}
		...
		function n(t, n) {
			var i = t.redirect,
				u = "function" == typeof i ? i(c(t, n)) : i;
			if("string" == typeof u && (u = {
					path: u
				}), !u || "object" != typeof u) return o(!1, "invalid redirect option: " + JSON.stringify(u)), a(null, n);
			var s = u,
				p = s.name,
				h = s.path,
				l = n.query,
				d = n.hash,
				y = n.params;
			if(l = s.hasOwnProperty("query") ? s.query : l, d = s.hasOwnProperty("hash") ? s.hash : d, y = s.hasOwnProperty("params") ? s.params : y, p) {
				var v = f[p];
				return r(v, 'redirect failed: named route "' + p + '" not found.'), e({
					_normalized: !0,
					name: p,
					query: l,
					hash: d,
			...
			if(h) {
				var m = z(h, t),
					g = B(m, y, 'redirect route with path "' + m + '"');
				return e({
					_normalized: !0,
					path: g,
					query: l,
		...
		function i(t, n, r) {
			var o = B(r, n.params, 'aliased route with path "' + r + '"'),
				i = e({
					_normalized: !0,
					path: o
				});
			if(i) {
				var u = i.matched,
					c = u[u.length - 1];
				return n.params = i.params, a(c, n)
			}
			return a(null, n)
		}
	...
	function V(t) {
		var e, n, r = _t[t];
		return r ? (e = r.keys, n = r.regexp) : (e = [], n = Ot(t, e), _t[t] = {
			keys: e,
			regexp: n
		}), {
			keys: e,
	...
	function M(t, e, n) {
		...
		for(var u = 1, c = a.length; u < c; ++u) {
			var s = i[u - 1],
				f = "string" == typeof a[u] ? decodeURIComponent(a[u]) : a[u];
			s && (e[s.name] = f)
		}
		return !0
	}
	...
	function H(t) {
		return St[t] || (St[t] = V(t).keys.map(function(t) {
			return t.name
		}))
	}
	...
	function N(t) {
		return Z(Q(t, function(t, e) {
			var n = J(t, "beforeRouteLeave");
	...
	function X(t, e, n) {
		return Z(Q(t, function(t, r, o, i) {
			var a = J(t, "beforeRouteEnter");
	...
	var lt, dt = {
			...
			render: function(t, e) {
				var n = e.props,
					...
					i = e.data;
				i.routerView = !0;
				for(var a = o.$route, u = o._routerViewCache || (o._routerViewCache = {}), c = 0, s = !1; o;) o.$vnode && o.$vnode.data.routerView && c++, o._inactive && (s = !0), o = o.$parent;
				i.routerViewDepth = c;
				var f = a.matched[c];
				if(!f) return t();
				var p = n.name,
					h = s ? u[p] : u[p] = f.components[p];
				if(!s) {
					var l = i.hook || (i.hook = {});
					l.init = function(t) {
						f.instances[p] = t.child
					}, l.prepatch = function(t, e) {
						f.instances[p] = e.child
					}, l.destroy = function(t) {
						f.instances[p] === t.child && (f.instances[p] = void 0)
					}
				}
				return t(h, i, r)
			}
		...
		bt = {
			...
			render: function(t) {
				var e = this,
					...
					d = o.path ? c(null, o) : i;
				f[h] = this.exact ? p(r, d) : l(r, d);
				var g = {
						click: function(t) {
							if(!(t.metaKey || t.ctrlKey || t.shiftKey || t.defaultPrevented || 0 !== t.button)) {
								var r = t.target.getAttribute("target");
								/\b_blank\b/i.test(r) || (t.preventDefault(), e.replace ? n.replace(o) : n.push(o))
							}
						}
					},
					w = {
				...
				if("a" === this.tag) w.on = g, w.attrs = {
					...
					if(b) {
						b.isStatic = !1;
						var x = lt.util.extend,
							k = b.data = x({}, b.data);
						k.on = g;
						var O = b.data.attrs = x({}, b.data.attrs);
						O.href = s
					} else w.on = g
				}
	...
	Ot.parse = Et, Ot.compile = jt, Ot.tokensToFunction = Rt, Ot.tokensToRegExp = At;
	var _t = Object.create(null),
		...
		Pt = function(t, e) {
			this.router = t, this.base = I(e), this.current = mt, this.pending = null
		};
	Pt.prototype.listen = function(t) {
		this.cb = t
	}, Pt.prototype.transitionTo = function(t, e) {
		var n = this,
			r = this.router.match(t, this.current);
		this.confirmTransition(r, function() {
			n.updateRoute(r), e && e(r), n.ensureURL()
		})
	}, Pt.prototype.confirmTransition = function(t, e) {
		var n = this,
			r = this.current;
		if(p(t, r)) return void this.ensureURL();
		var o = D(this.current.matched, t.matched),
			i = o.deactivated,
			a = o.activated,
			u = [].concat(N(i), this.router.beforeHooks, a.map(function(t) {
				return t.beforeEnter
			}), G(a));
		this.pending = t;
		var c = function(e, o) {
			n.pending === t && e(t, r, function(t) {
				t === !1 ? n.ensureURL(!0) : "string" == typeof t || "object" == typeof t ? n.push(t) : o(t)
			})
		};
		F(u, c, function() {
			var r = [],
	...
	var Ut = Object.create(null),
		...
		Mt = function(t) {
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.go = function(t) {
				...
				this.transitionTo(t, function(t) {
					ut(n(e.base + t.fullPath)), e.handleScroll(t, r, !1)
				})
			}, e.prototype.replace = function(t) {
				var e = this,
					r = this.current;
				this.transitionTo(t, function(t) {
					ct(n(e.base + t.fullPath)), e.handleScroll(t, r, !1)
				})
		...
		Bt = function(t) {
			function e(e, n, r) {
				t.call(this, e, n), r && this.checkFallback() || st()
			}
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.checkFallback = function() {
				var t = at(this.base);
				if(!/^\/#/.test(t)) return window.location.replace(n(this.base + "/#" + t)), !0
			}, e.prototype.onHashChange = function() {
				st() && this.transitionTo(ft(), function(t) {
					ht(t.fullPath)
				})
			}, e.prototype.push = function(t) {
				this.transitionTo(t, function(t) {
		...
		zt = function(t) {
			void 0 === t && (t = {}), this.app = null, this.options = t, this.beforeHooks = [], this.afterHooks = [], this.match = L(t.routes || []);
			var e = t.mode || "hash";
			switch(this.fallback = "history" === e && !Ct, this.fallback && (e = "hash"), qt || (e = "abstract"), this.mode = e, e) {
				case "history":
	...
	return Ft.currentRoute.get = function() {
		return this.history && this.history.current
	}, zt.prototype.init = function(t) {
		var e = this;
		r(g.installed, "not installed. Make sure to call `Vue.use(VueRouter)` before creating root instance."), this.app = t;
		var n = this.history;
		n instanceof Mt ? n.transitionTo(at(n.base)) : n instanceof Bt && n.transitionTo(ft(), function() {
		...
		this.history.push(t)
	}, zt.prototype.replace = function(t) {
		...
		this.go(1)
	}, zt.prototype.getMatchedComponents = function() {
		return this.currentRoute ? [].concat.apply([], this.currentRoute.matched.map(function(t) {
			return Object.keys(t.components).map(function(e) {
				return t.components[e]
			})
		})) : []
	}, Object.defineProperties(zt.prototype, Ft), zt.install = g, qt && window.Vue && window.Vue.use(zt), zt
});